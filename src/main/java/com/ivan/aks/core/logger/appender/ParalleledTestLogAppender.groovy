package com.ivan.aks.core.logger.appender
...
final class ParalleledTestLogAppender extends AbstractAppender {
    ...
    void append(LogEvent event) {
        ...
        try {
            ...
            //clean unnecessary data into message
            String message = immutableEvent.message
            message = StringUtils.substringAfter(message, 'ParameterizedMessage[messagePattern=')
            message = StringUtils.substringBefore(message, ', stringArgs')
    ...
    @PluginFactory
    ParalleledTestLogAppender createAppender(
